...
import MixinAccount from './mixinAccount';
...
export default observer((props: any) => {
  ...
  const [tab, setTab] = React.useState(props.tab || 'assets');
        ...
        <div className="w-3/12">
          <div className="py-8 px-6">
            ...
            <div className="ml-2 mt-3">
              ...
              <Tab tab={tab} thisTab="mixinAccount" onClick={() => setTab('mixinAccount')}>
                <Badge
                  badgeContent={1}
                  className="pr-1"
                  color="error"
                  variant="dot"
                  invisible={!userStore.isFetched || !!userStore.user.mixinAccount}
                >
                  <div className="flex items-center">
                    <span className="text-lg mr-2 flex items-center">
                      <AccountCircle />
